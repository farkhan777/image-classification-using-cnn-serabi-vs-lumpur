# Deployment Model CNN (Serabi VS Lumpur)

## Deskripsi singkat

Repository ini berisi semua file yang dibutuhkan untuk melakukan deployment model Machine Learning Image Classification menggunakan CNN (Convolutional Neural Network). Adapun model yang digunakan merupakan model untuk memprediksi gambar lumpur atau serabi.

#

## Sekilas mengenai input model

Agar dapat memprediksi daun serabi atau lumpur, data input model harus mengikuti format sebagai berikut:
...
1. Buka URL dengan browser, coba masukkan gambar serabi atau lumpur yang ingin di prediksi.
1. Anda akan diberikan prediksi bahwa pada gambar tersebut adalah serabi atau lumpur pada halaman website.
